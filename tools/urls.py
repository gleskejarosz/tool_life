...
urlpatterns = [
    ...
    path("select_machine/", views.select_machine, name="select-machine"),
    path("select_station/<machine_id>/", views.select_station, name="select-station"),
    path("select_tool/<station_id>/", views.select_tool, name="select-tool"),
